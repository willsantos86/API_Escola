...
A API foi desenvolvida utilizando a linguagem python e o Django Rest framework, integrando os dados com o banco de dados SQLite3 e vinculando o Admin do Django com a API. Foi trabalhado os conceitos de serializers e viewsets seguindo boas práticas de programação.

A aplicação consiste na criação de uma API de uma escola, no qual é possivel criar, visualizar e atualizar os dados de alunos e cursos. Os dois recursos serão vinculados na criação das matrículas dos alunos.
